...
const Footer = ({ prescriberEmail, setPrescriberEmail, prescriberPassword, setPrescriberPassword, OTP, setOTP, getOTP, checkOTP, OTPVerified }) => {
  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} align='center'>
        <Button onClick={() => {setShowOTPField(true); getOTP()}}>Get OTP</Button>
      </Grid>
      {showOTPField && <Grid item xs={12} align='center'>
